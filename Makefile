...
#    Updated: 2021/10/11 13:23:23 by cfico-vi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MAIN_F		= ${MAIN}/push_swap_0.c
MAIN_OBJ	= push_swap_0.o
OPS_F		= ${OPS}/exit_0.c ${OPS}/check_sorted_0.c ${OPS}/parse_0.c ${OPS}/print_steps_0.c ${OPS}/sort_stacks_0.c
OPS_OBJ		= exit_0.o check_sorted_0.o parse_0.o print_steps_0.o sort_stacks_0.o
